                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-xl-6">
                                        <div class="card mt-3 mb-3">
                                            ...
                                            <div class="form-wrap">
                                                <form method="POST" id="doc_form" action="<?php echo e(route('hr.store_holiday')); ?>" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                    <div class="form-group">
                                                        <label>Holiday Name <span class="required-icon"></span></label>
                                                        <input class="form-control" name="holiday" id="holiday" value="<?php echo e(old('holiday')); ?>">
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <input class="date form-control" id='datetimepicker' name="holiday_date" value="<?php echo e(old('holiday_date')); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/add_holiday.blade.php ENDPATH**/ ?>