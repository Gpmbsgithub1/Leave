            ...
            <td align="center " valign="top " style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-top: 5px; " bgcolor="#FFFFFF ">
                ...
                <table border="0 " cellpadding="0 " cellspacing="0 " align="center " width="600 " style="border-collapse: collapse; border-spacing: 0; padding: 0; width: 100%; max-width: 600px; ">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <img src="<?php echo e(asset('content/img/doc.png')); ?>" style="
    width: 70px;
...
">
                        ...
                        <td align="center " valign="top " style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; padding-top: 10px;padding-bottom: 25px; ">
                            <h1 style="font-family: sans-serif;font-size: 20px;color: #3d3d3d;margin-bottom: 5px;text-align: left;font-weight: 300;margin-top: 20px;padding: 0px ;font-weight: bold; "><?php echo e($doc->document_name); ?> Uploaded</h1>
                            <h6 style="font-family: sans-serif;font-size: 18px;color: #3d3d3d;margin-bottom: 5px;text-align: left;font-weight: 300;margin-top: 30px;padding: 0px ; ">Dear <?php echo e($employee->name); ?>,</h6>
                            <p style="font-family: sans-serif;font-size: 16px;color: #3d3d3d;margin-bottom: 5px;text-align: left;font-weight: 300;margin-top: 20px;padding: 0px ; "><?php echo e($doc->document_name); ?> is uploaded to your folder.</p>
                        </td>
                    </tr>

                    <tr>
                        <td align="left " style="padding-bottom: 50px;padding-top: 45px;padding-left: 30px; ">
                            <?php if($employee->hr==1): ?>
                            <a target="blank " href="<?php echo e(route('employee.documents')); ?>" style=" margin-right: 15px; cursor:pointer; background: #ffffff; width: 70px; color: #3d3d3d; font-family: sans-serif; font-size: 14px; padding: 10px 15px; border-radius: 25px; font-weight: 600;
                        text-decoration: none; margin-bottom: 35px; border: 2px solid #4caf50; text-align: center; ">View</a>
                        <?php elseif($employee->hr==0): ?>
                        <a target="blank " href="<?php echo e(route('employee.documents')); ?>" style=" margin-right: 15px; cursor:pointer; background: #ffffff; width: 70px; color: #3d3d3d; font-family: sans-serif; font-size: 14px; padding: 10px 15px; border-radius: 25px; font-weight: 600;
                        text-decoration: none; margin-bottom: 35px; border: 2px solid #4caf50; text-align: center; ">View</a>
                        <?php endif; ?>
                        </td>
...
</body></html><?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/emails/doc_upload.blade.php ENDPATH**/ ?>