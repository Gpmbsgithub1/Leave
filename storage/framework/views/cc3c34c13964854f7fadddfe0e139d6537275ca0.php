        ...
        <div class="side-bar d-lg-block d-none">
          <ul>
            <li><a href="<?php echo e(route('employee.request_leave')); ?>"><i class="material-icons">add_circle</i> Request Leave</a></li>
             <li><a href="<?php echo e(route('employee.leaves')); ?>" class="active"><i class="material-icons">person</i> Applied</a></li>
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <?php $__currentLoopData = $leave; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $leaves): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <?php if($leaves->leave_type=='medical_leave'): ?>
                                                            <td>Medical Leave</td>
                                                            <?php elseif($leaves->leave_type=='paternity_leave'): ?>
                                                            <td>Paternity Leave</td>
                                                            <?php elseif($leaves->leave_type=='maternity_leave'): ?>
                                                            <td>Maternity Leave</td>
                                                            <?php elseif($leaves->leave_type=='bereavement_leave'): ?>
                                                            <td>Bereavement Leave</td>
                                                            <?php elseif($leaves->leave_type=='comp_off'): ?>
                                                            <td>Comp Off Leave</td>
                                                            <?php elseif($leaves->leave_type=='casual_leave'): ?>
                                                            <td>Casual Leave</td>
                                                            <?php elseif($leaves->leave_type=='loss_of_pay'): ?>
                                                            <td>Loss of Pay</td>
                                                            <?php elseif($leaves->leave_type=='half_day'): ?>
                                                            ...
                                                            <td>
                                                                <div class="dropdown dropleft">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                        <a class="dropdown-item" href="<?php echo e(route('employee.view_leave', $leaves->id)); ?>">View</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
...
<?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/employee/leave.blade.php ENDPATH**/ ?>