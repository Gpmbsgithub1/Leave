...
<div class="main-wrap">
    ...
    <div class="row">
      <div class="col-lg-2">
        <div class="side-bar d-lg-block d-none">
          <ul>
             <li><a href="<?php echo e(route('employee.groups')); ?>" class="active"><i class="material-icons">people</i> Groups</a></li>
          </ul>
        </div>
      </div>
      <div class="col-lg-10 pr-0 pl-0">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-xl-12">
           <div class="row">
            <?php $__currentLoopData = $group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $grps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <!-- item -->
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <a class="dropdown-item" href="<?php echo e(route('employee.group_members', $grps->group_id)); ?>">View</a>
    ...
    <a class="dropdown-item" href="#" data-toggle="modal" data-target=".bd-example-modal-sm-<?php echo e($grps->id); ?>">Delete</a> -->
                ...
                <span><i class="material-icons icon">supervised_user_circle</i><b><?php echo e($group[$k]->members); ?> Members</b></span>
                 <a href="<?php echo e(route('employee.group_members', $grps->group_id)); ?>"><h6><?php echo e($grps->gp->group_name); ?></h6> </a>
                 <ul class="pl-0 mb-0">
                   <li><span><i class="material-icons">watch_later</i> <?php echo e(date('d-m-y', strtotime($group[$k]->gp->created_at))); ?></span></li>
                   <li><span><i class="material-icons">settings</i> <?php echo e($group[$k]->user->name); ?></span></li>
                 </ul>
               </div>
...
<?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/employee/group.blade.php ENDPATH**/ ?>