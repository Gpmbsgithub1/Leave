...
<div class="main-wrap">
    ...
    <div class="row">
      <div class="col-lg-2">
        <div class="side-bar d-lg-block d-none">
          <ul>
          <li><a href="<?php echo e(route('hr.create_employee')); ?>"><i class="material-icons">add_circle</i> Create Employee</a></li>
             <li><a href="<?php echo e(route('hr.employees')); ?>" class="active"><i class="material-icons">person</i> Employees</a></li>
 ...
 <!-- item -->
  ...
  <tbody>
<?php if($emp->count()): ?>
  <?php $__currentLoopData = $emp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $emps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      <!-- <th> 
        <div class="custom-checkbox">
        <input type="checkbox" id="box-1" name="select_employee" value="<?php echo e($emps->id); ?>">
  <label for="box-1"></label>
</div>
</th> -->
      <th scope="row"><?php echo e(++$i); ?></th>
       <td><?php echo e($emps->employee_id); ?></td>
      ...
      <?php endif; ?>
      <td><?php echo e($emps->designation); ?></td>
     
      <td><?php echo e($emps->email); ?></td>
      <td><?php echo e($emps->phone); ?></td>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item" href="#" data-toggle="modal" data-target=".bd-example-modal-sm-<?php echo e($emps->id); ?>">Inactivate</a>
    <a class="dropdown-item" href="#" data-toggle="modal" data-target=".bd-example-modal-sm1-<?php echo e($emps->id); ?>">Add to Group</a>
  </div>
</div></td>
    </tr>
  ...
  <?php endif; ?>
          ...
          <?php echo $emp->appends(request()->query())->links(); ?>
...
<!-- delete modal -->
<?php $__currentLoopData = $emp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $emps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade bd-example-modal-sm-<?php echo e($emps->id); ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    ...
    <div class="modal-content p-4">
     ...
     <span class="content">Do you really want to inactivate</span>
      <div class="button-holder">
             ...
             <a href="<?php echo e(route('hr.inact_employee', $emps->id)); ?>" class="btn btn-default mt-4 filz "><span>Inactivate</span></a>
           </div>
    </div>
  </div>
</div>
...
<!-- add to group modal -->
<?php $__currentLoopData = $emp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $emps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade bd-example-modal-sm1-<?php echo e($emps->id); ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content p-4">
     ...
     <form method="POST" action="<?php echo e(route('hr.group_employee', $emps->id)); ?>" enctype="multipart/form-data">
     	<?php echo csrf_field(); ?>
 			<div class="form-group">
               <label >Select Group <span class="required-icon"></span></label>
               <select class="form-control w-100 custom" name="group" required>
                <?php if(count($emp[$k]->man)>0): ?>
               	<?php $__currentLoopData = $emp[$k]->man; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <option value="<?php echo e($mans->id); ?>"><?php echo e($mans->group_name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/employee.blade.php ENDPATH**/ ?>