   ...
   <i class="material-icons md-light">account_circle</i>
                ...
                <div class="main-navigation d-lg-block d-none">
                    <ul class="mb-0">
                        ...
                        <li><a href="<?php echo e(route('hr.leave_requests')); ?>" class="active"><i class="material-icons md-light">holiday_village</i> Leave Request</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="side-bar d-lg-block d-none">
                                <ul>
                                    <li><a href="<?php echo e(route('hr.leave_requests')); ?>" class="active"><i class="material-icons">holiday_village</i> Leave Request</a></li>
                                    <li><a href="<?php echo e(route('hr.approved_leaves')); ?>" ><i class="material-icons">thumb_up</i> Approved</a></li>
                                    <li><a href="<?php echo e(route('hr.rejected_leaves')); ?>"><i class="material-icons">thumb_down</i> Rejected</a></li>
                                </ul>
                            </div>
                        </div>
...
<div class="button-holder">
             ...
             <button type="submit" class="btn btn-cancel mt-4 fils w-100"><span>Approve</span></button>
                                        ...
                                        <div class="table-list">
                                            ...
                                            <div class="card d-none d-lg-block">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php if(count($fleave)>0 && $fleave[0]!=null): ?>
                                                        <?php $__currentLoopData = $fleave; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $leaves): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                          
                                                            <th scope="row"><?php echo e(++$i); ?></th>
                                                            <td><?php echo e($leaves->employee_id); ?></td>
                                                            <td><?php echo e($fleave[$k]->user->name); ?></td>
                                                            <td><?php echo e(date('d M Y', strtotime($leaves->created_at))); ?></td>
                                                            <td><?php echo e($leaves->leave_type); ?></td>
                                                            <td><?php echo e(date('d M Y', strtotime($leaves->from_date))); ?></td>
                                                            <td><?php echo e(date('d M Y', strtotime($leaves->to_date))); ?></td>
                                                            <td><?php echo e($leaves->leave_reason); ?></td>
                                                            <td>
                                                            <a title="View Leave" href="<?php echo e(route('hr.view_leave', $leaves->id)); ?>" ><i class="material-icons md-light">visibility</i></a>
                                                            </td>
                                                            <td>
                                                                <div class="dropdown dropleft">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                        <a class="dropdown-item" href="<?php echo e(route('hr.leave_accept', $leaves->id)); ?>">Approve</a>
                                                                        <a class="dropdown-item" data-toggle="modal" data-target=".bd-example-modal-smr-<?php echo e($leaves->id); ?>">Reject</a>
                                        ...
                                        <?php echo $fleave->appends(request()->query())->links(); ?>

                                    </div>
                                </div>
                            </div>

                            <span class="powered">Copyright © 2021 Leave Tracker, All rights reserved. Powered by <a href="http://skiloratech.com/" target="_blank">Skilora Technoligies</a></span>
           ...
           <?php $__currentLoopData = $fleave; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $leaves): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <!-- reject modal -->
            <div class="modal fade bd-example-modal-smr-<?php echo e($leaves->id); ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    ...
                    <div class="modal-content p-4">
                        ...
                        <form method="POST" action="<?php echo e(route('hr.leave_reject', $leaves->id)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/leave_request.blade.php ENDPATH**/ ?>