                            ...
                            <div class="dash-right-wrap">
                                <div class="row">
                                    <div class="col-lg-12 col-xl-6 col-md-12">
                                        <h2 class="page-head">Employee Salary - <?php echo e($employee->name); ?> - Salary Slip</h2>
                                    </div>
                ...
                <tr class="top">
                    <td colspan="4">
                        <table>
                            <tr>
                                <td class="title">
                                    <img src="<?php echo e(asset('content/img/logodark.png')); ?>" style="width: 100%; max-width: 100px" />
                                </td>
                                <td align="right">
                                   <?php echo e(date('F')); ?> <?php echo e(date('d')); ?> , <?php echo e(date('Y')); ?><br />
                                   Calicut
                                </td>
                            </tr>
                        </table>
                        ...
                        <table>
                            <tr class="boarder-btm">
                             ...
                             <tr class="boarder-btm">
                                ...
                                <td><b>Pay Date</b></td>
                                <td>: <?php echo e(date('F')); ?> 25, <?php echo e(date('Y')); ?></td>
                            </tr>
                             <tr class="boarder-btm">
...
<?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/salary_slip.blade.php ENDPATH**/ ?>