...
<div class="main-navigation d-lg-block d-none">
  <ul class="mb-0">
    <li><a href="<?php echo e(route('hr.home')); ?>" class="active"><i class="material-icons md-light">dashboard</i> Dashboard</a></li>
    ...
    <?php if(date('m')>=25 && date('m')<=31): ?>
    <li title="This link will be enabled next month"><a href="<?php echo e(route('hr.salary')); ?>" style="pointer-events: none"><i class="material-icons md-light">account_balance_wallet</i> Employee Salary</a></li>
    <?php else: ?>
    <li><a href="<?php echo e(route('hr.salary')); ?>" id="salary"><i class="material-icons md-light">account_balance_wallet</i> Employee Salary</a></li>
    <?php endif; ?>
...
<li class="has-submenu">
          ...
          <div id="stores" class="submenu">
            ...
            <ul>
              <li>
                <a href="<?php echo e(route('hr.create_employee')); ?>"><span class="plus-icon"></span> Create Employee</a>
              </li>
               <li> <a href="<?php echo e(route('hr.employees')); ?>">Employees</a>   </li>
               <li> <a href="<?php echo e(route('hr.inactive_employees')); ?>">Inactive Employees</a>   </li>
            </ul>
          </div>
        </li>
         <li class="has-submenu">
        ...
        <li class="has-submenu">
          ...
          <div id="stores2" class="submenu">
            ...
            <ul>
              <li>
                <a href="<?php echo e(route('hr.leave_requests')); ?>"> Leave Request</a>
              </li>
               <li> <a href="<?php echo e(route('hr.approved_leaves')); ?>" >Approved Leaves</a></li>
               <li> <a href="<?php echo e(route('hr.rejected_leaves')); ?>" >Rejected Leaves</a></li>
            </ul>
          </div>
        </li>
        <li class="has-submenu">
          ...
          <div id="stores3" class="submenu">
            ...
            <ul>
              <li>
                <a href="<?php echo e(route('hr.add_document')); ?>"><span class="plus-icon"></span> Upload Document</a>
              </li>
               <li> <a href="<?php echo e(route('hr.documents')); ?>">Documents</a>   </li>
            </ul>
          </div>
        </li>
        ...
        <li class="has-submenu">
          ...
          <div id="stores4" class="submenu">
            ...
            <ul>
              <li>
                <a href="<?php echo e(route('hr.add_award')); ?>"><span class="plus-icon"></span> Add Award</a>
              </li>
               <li> <a href="<?php echo e(route('hr.awards')); ?>">Awards</a>   </li>
            </ul>
          </div>
        </li>
                </ul>
       ...
       <div class="col-lg-4 col-md-5">
         ...
         <div class="row">
            <div class="col-lg-6 col-6">
              <a href="<?php echo e(route('hr.employees')); ?>">
          <div class="card p-4 anl">
            <i class="material-icons md-light bl-gradient">person</i>
            <span>Employees</span>
            <h5><?php echo e($employee); ?></h5>
          </div>
        </a>
        </div>
        <div class="col-lg-6 col-6">
          <a href="<?php echo e(route('hr.groups')); ?>">
          <div class="card p-4 anl">
...
<span class="sub">Casual Leave</span>
  ...
  <!-- responsive-block end -->
          ...
          <div class="d-none d-lg-block">
             <h2 class="page-head">Employees On Leave Today
 <span class="float-right">
               <a href="<?php echo e(route('hr.approved_leaves')); ?>">View All</a>
             </span>
             </h2>
  ...
  <tbody>
    <?php if($leave->count()): ?>
    <?php $__currentLoopData = $leave->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $leaves): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      <th scope="row"><?php echo e($leaves->employee_id); ?></th>
      <td><?php echo e($leave[$k]->user->name); ?></td>
...
<span class="sub">+91 97476 33769</span>
   ...
   <!-- responsive-block end -->       
         ...
         <h2 class="page-head">Leave Request
 <span class="float-right">
               <a href="<?php echo e(route('hr.leave_requests')); ?>">View All</a>
             </span>
             </h2>
         <div class="card ">
             <table class="table table-hover mb-0">
  ...
  <tbody>
    ...
    <?php $__currentLoopData = $request->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $requests): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      <th scope="row"><?php echo e($requests->employee_id); ?></th>
      <td><?php echo e($request[$k]->user->name); ?></td>
      <td><?php echo e($requests->leave_type); ?></td>
      <td><?php echo e(@$requests->dates); ?></td>
      <td><?php echo e($requests->leave_reason); ?></td>
      <td> <div class="dropdown dropleft">
       <a class="btn p-0 dropdown-toggle " href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <i class="material-icons">more_vert</i>
       </a>
       <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
       <a class="dropdown-item" href="<?php echo e(route('hr.leave_accept', $requests->id)); ?>">Approve</a>
       <a class="dropdown-item" data-toggle="modal" data-target=".bd-example-modal-smr-<?php echo e($requests->id); ?>">Reject</a>
       </div>
        </div>
      </td>
    </tr>
...
<h2 class="page-head">Newly Joined Employees
 <span class="float-right">
               <a href="<?php echo e(route('hr.employees')); ?>">View All</a>
             </span>
             </h2>
         <div class="card ">
             <table class="table table-hover mb-0">
  ...
  <tbody>
    <?php if($emp->count()): ?>
    <?php $__currentLoopData = $emp->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $emps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
       <th scope="row"><?php echo e(++$i); ?></th>
      <th ><?php echo e($emps->employee_id); ?></th>
       <td><?php echo e(date('d M Y', strtotime($emps->joining_date))); ?></td>
      <?php if($emps->hr==1): ?>
      <td class="hr"><?php echo e($emps->name); ?></td>
      <?php else: ?>
      <td><?php echo e($emps->name); ?></td>
      <?php endif; ?>

      <td><?php echo e($emps->email); ?></td>
      <td>+91 <?php echo e($emps->phone); ?></td>
      <td> <div class="dropdown dropleft">
       <a class="btn p-0 dropdown-toggle " href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <i class="material-icons">more_vert</i>
       </a>
       <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
       <a class="dropdown-item" href="<?php echo e(route('hr.edit_employee', $emps->id)); ?>">Edit</a>
       </div>
        </div>
      </td>
    </tr>
...
<?php $__currentLoopData = $request; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $requests): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <!-- reject modal -->
            <div class="modal fade bd-example-modal-smr-<?php echo e($requests->id); ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    ...
                    <div class="modal-content p-4">
                        ...
                        <form method="POST" action="<?php echo e(route('hr.leave_reject', $requests->id)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/home.blade.php ENDPATH**/ ?>