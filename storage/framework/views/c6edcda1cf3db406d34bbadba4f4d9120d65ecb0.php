                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-xl-6">
                                        <div class="card mt-3 mb-3">
                                            ...
                                            <div class="form-wrap">
                                                <form method="POST" id="doc_form" action="<?php echo e(route('hr.add_award_store')); ?>" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/add_award.blade.php ENDPATH**/ ?>