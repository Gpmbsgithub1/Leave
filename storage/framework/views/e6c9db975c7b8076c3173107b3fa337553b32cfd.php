                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="side-bar d-lg-block d-none">
                                <ul>
                                    <li><a href="<?php echo e(route('hr.leave_requests')); ?>"><i class="material-icons">holiday_village</i> Leave Request</a></li>
                                    <li><a href="<?php echo e(route('hr.approved_leaves')); ?>" class="active"><i class="material-icons">thumb_up</i> Approved</a></li>
...
</html><?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/approved_leaves.blade.php ENDPATH**/ ?>