...
<body class="grey-bg">
   ...
   <i class="material-icons md-light">account_circle</i>
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="side-bar d-lg-block d-none">
                                <ul>
                                    <li><a href="<?php echo e(route('hr.add_document')); ?>"><i class="material-icons">publish</i> Upload Document</a></li>
                                    <li><a href="<?php echo e(route('hr.documents')); ?>" class="active"><i class="material-icons">folder</i> Documents</a></li>
                                    <li><a href="<?php echo e(route('hr.my_docs')); ?>"><i class="material-icons">folder</i> My Documents</a></li>
                                    <li><a href="<?php echo e(route('hr.slip')); ?>"><i class="material-icons">folder</i>Salary Slip</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="dash-right-wrap">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-xl-12">
                                        ...
                                        <div class="table-list">
                                            ...
                                            <div class="card d-none d-lg-block">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php if($doc->count()): ?>
                                                        <?php $__currentLoopData = $doc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $docs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>

                                                            <th scope="row"><?php echo e(++$i); ?></th>
                                                            <td><?php echo e($docs->document_name); ?></td>
                                                            <?php if($docs->employee=='all'): ?>
                                                            <td>All</td>
                                                            <?php else: ?>
                                                            <td><?php echo e(@$doc[$k]->user->employee_id); ?></td>
                                                            <?php endif; ?>
                                                            <?php if($docs->employee=='all'): ?>
                                                            <td>All</td>
                                                            <?php else: ?>
                                                            <td><?php echo e(@$doc[$k]->user->name); ?></td>
                                                            <?php endif; ?>
                                                            <td><?php echo e($docs->description); ?></td>
                                                            ...
                                                            <td>
                                                                <div class="dropdown dropleft">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                        <a class="dropdown-item" href="<?php echo e(route('hr.view_document', $docs->id)); ?>">View</a>
                                                                        <a class="dropdown-item" href="<?php echo e(route('hr.edit_document', $docs->id)); ?>">Edit</a>
                                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target=".bd-example-modal-sm-<?php echo e($docs->id); ?>">Delete</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                        ...
                                        <?php echo $doc->appends(request()->query())->links(); ?>
            ...
            <?php $__currentLoopData = $doc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $docs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <!-- delete modal -->
            <div class="modal fade bd-example-modal-sm-<?php echo e($docs->id); ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content p-4">
                        ...
                        <div class="button-holder">
                            ...
                            <a class="btn btn-default mt-4 filz" href="<?php echo e(route('hr.delete_document', $docs->id)); ?>"><span>Delete</span></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/docs.blade.php ENDPATH**/ ?>