        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-xl-6">
            <div class="card mt-3 mb-3">
              ...
              <div class="form-wrap">
                <form method="POST" id="leave_form" action="<?php echo e(route('employee.change_password.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                  <input type="hidden" name="pass" value="<?php echo e($user->pass); ?>">
             <div class="form-group">
               <label >Old Password <span class="required-icon"></span></label>
                <input type="Password" id="old_password" name="old_password" value="<?php echo e(old('old_password')); ?>" class="form-control" placeholder="Old Password" aria-label="Password" aria-describedby="password-addon">
             ...
             <div class="form-group">
               <label >New Password <span class="required-icon"></span></label>
                <input type="Password" id="new_password" name="new_password" value="<?php echo e(old('new_password')); ?>" class="form-control" placeholder="New Password" aria-label="Password" aria-describedby="password-addon">
             ...
             <div class="form-group">
               <label >Confirm Password <span class="required-icon"></span></label>
                <input type="Password" id="confirm_password" name="confirm_password" value="<?php echo e(old('confirm_password')); ?>" class="form-control" placeholder="Confirm Password" aria-label="Password" aria-describedby="password-addon">
...
<?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/employee/change_password.blade.php ENDPATH**/ ?>