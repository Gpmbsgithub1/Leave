...
<div class="main-navigation d-lg-block d-none">
  <ul class="mb-0">
    ...
    <li><a href="<?php echo e(route('employee.documents')); ?>" class="active"><i class="material-icons md-light">folder</i> Documents</a></li>
    <?php if(isset($grp)): ?>
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="side-bar d-lg-block d-none">
                                <ul>
                                    <li><a href="<?php echo e(route('employee.documents')); ?>" class="active"><i class="material-icons">folder</i>Documents</a></li>
                                    <li><a href="<?php echo e(route('employee.salary_slip')); ?>"><i class="material-icons">folder</i>Salary Slip</a></li>
                                </ul>
                            </div>
                        </div>
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="<?php echo e(route('employee.view_document', $docs->id)); ?>"><?php echo e($docs->document_name); ?></a></td>
                                                            ...
                                                            <td>
                                                                <div class="dropdown dropleft">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                        <a class="dropdown-item" href="<?php echo e(route('employee.view_document', $docs->id)); ?>">View</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
...
</html><?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/employee/docs.blade.php ENDPATH**/ ?>