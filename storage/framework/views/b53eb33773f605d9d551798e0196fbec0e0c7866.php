                            ...
                            <div class="dash-right-wrap">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-xl-12">
                                        ...
                                        <div class="table-list">
                                            ...
                                            <div class="card d-none d-lg-block">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php if($awd->count()): ?>
                                                        <?php $__currentLoopData = $awd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $docs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>

                                                            <th scope="row"><?php echo e(++$i); ?></th>
                                                            <td><?php echo e($docs->award_name); ?></td>
                                                            <?php if($docs->employee=='all'): ?>
                                                            <td>All</td>
                                                            <?php else: ?>
                                                            <td><?php echo e(@$awd[$k]->user->employee_id); ?></td>
                                                            <?php endif; ?>
                                                            <?php if($docs->employee=='all'): ?>
                                                            <td>All</td>
                                                            <?php else: ?>
                                                            <td><?php echo e(@$awd[$k]->user->name); ?></td>
                                                            <?php endif; ?>
                                                            ...
                                                            <td>
                                                                <div class="dropdown dropleft">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                        <a class="dropdown-item" href="<?php echo e(route('hr.view_award', $docs->id)); ?>">View</a>
                                                                        <a class="dropdown-item" href="<?php echo e(route('hr.edit_award', $docs->id)); ?>">Edit</a>
                                        ...
                                        <?php echo $awd->appends(request()->query())->links(); ?>
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content p-4">
                        ...
                        <div class="button-holder">
                            ...
                            <a class="btn btn-default mt-4 filz" href="<?php echo e(route('hr.delete_award', $docs->id)); ?>"><span>Delete</span></a>
                        </div>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/awards.blade.php ENDPATH**/ ?>