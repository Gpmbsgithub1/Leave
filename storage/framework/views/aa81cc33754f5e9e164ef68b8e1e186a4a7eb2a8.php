        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-xl-6">
            <div class="card mt-3 mb-3">
              ...
              <div class="form-wrap">
                <form method="POST" id="group_form" action="<?php echo e(route('hr.create_group_store')); ?>">
                        <?php echo csrf_field(); ?>
                  <div class="form-group">
               <label >Group Name <span class="required-icon"></span></label>
                <input id="group_name" class="form-control" type="text" name="group_name" value="<?php echo e(old('group_name')); ?>">
              ...
              <div class="form-group">
               <label >Manager <span class="required-icon"></span></label>
                <select class="form-control w-100 custom" name="manager">
                  <?php $__currentLoopData = $man; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($mans->id); ?>"><?php echo e($mans->name); ?> - <?php echo e($mans->employee_id); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php if($errors->has('manager')): ?>
                 <span class="invalid-feedback" role="alert">
                 <?php echo e($errors->first('manager')); ?>
...
<?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/create_group.blade.php ENDPATH**/ ?>