                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="side-bar d-lg-block d-none">
                                <ul>
                                    <li><a href="<?php echo e(route('hr.add_holiday')); ?>" class="active"><i class="material-icons">add_circle</i> Add Holiday</a></li>
                                    <li><a href="<?php echo e(route('hr.holiday')); ?>"><i class="material-icons">folder</i> Holidays</a></li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-xl-6">
                                        <div class="card mt-3 mb-3">
                                            ...
                                            <div class="form-wrap">
                                                <form method="POST" id="doc_form" action="<?php echo e(route('hr.edit_holiday_store', $holiday->id)); ?>" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                    <div class="form-group">
                                                        <label>Holiday Name <span class="required-icon"></span></label>
                                                        <input class="form-control" name="holiday" id="holiday" value="<?php echo e($holiday->holiday); ?>">
                                                        <?php if($errors->has('holiday')): ?>
                                                        <span class="invalid-feedback" role="alert">
                                                         <?php echo e($errors->first('holiday')); ?>
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <input class="date form-control" id='datetimepicker' name="holiday_date" value="<?php echo e(date('m/d/Y', strtotime($holiday->dt))); ?>">
                                                      <div><i style="float: right;margin-top: -30px;margin-right: 15px !important;" class="material-icons mr-2">calendar_today</i></div>
                                                        <?php if($errors->has('holiday_date')): ?>
                                                         <span class="invalid-feedback" role="alert">
                                                         <?php echo e($errors->first('holiday_date')); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="4" name="description"><?php echo e($holiday->description); ?></textarea>
...
</html><?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/edit_holiday.blade.php ENDPATH**/ ?>