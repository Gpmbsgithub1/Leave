    ...
    <div class="row">
      <div class="col-lg-2">
        <div class="side-bar d-lg-block d-none">
          <ul>
            <li><a href="<?php echo e(route('hr.create_group')); ?>" class="active"><i class="material-icons">add_circle</i> Create Group</a></li>
             <li><a href="<?php echo e(route('hr.groups')); ?>"><i class="material-icons">people</i> Groups</a></li>
          </ul>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-xl-6">
            <div class="card mt-3 mb-3">
              ...
              <div class="form-wrap">
                <form method="POST" id="group_form" action="<?php echo e(route('hr.edit_group_store', $grp->id)); ?>">
                        <?php echo csrf_field(); ?>
                  <div class="form-group">
               <label >Group Name <span class="required-icon"></span></label>
                <input class="form-control" type="text" name="group_name" value="<?php echo e($grp->group_name); ?>" required>
             </div>
              <div class="form-group">
               <label >Manager <span class="required-icon"></span></label>
                <select class="form-control w-100 custom" name="manager">
                  <?php $__currentLoopData = $man; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $mans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($mans->id); ?>" <?php if($grp->manager == $mans->id): ?> selected <?php endif; ?>><?php echo e($mans->name); ?> - <?php echo e($mans->employee_id); ?></option>
...
<?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/edit_group.blade.php ENDPATH**/ ?>