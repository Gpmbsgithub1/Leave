                        ...
                        <div class="col-lg-2">
                            <div class="side-bar d-lg-block d-none">
                                <ul>
                                    ...
                                    <li><a href="<?php echo e(route('hr.slip')); ?>" class="active"><i class="material-icons">folder</i>Salary Slip</a></li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="col-lg-12 col-xl-12">
                                        ...
                                        <div class="table-list">
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                  <?php if($salary->count()): ?>
                                                    <?php $__currentLoopData = $salary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $salaries): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($salaries->employee_id); ?></td>
                                                        <td><?php echo e($salaries->date); ?></td>
                                                        <td>
                                                            <a href="<?php echo e(route('hr.view_salary_slip', $salaries->id)); ?>" class="btn btn-cancel fils"><span>View</span></a>
                                                        </td>
                                                    </tr>
                                        ...
                                        <?php echo $salary->appends(request()->query())->links(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/sal_slip.blade.php ENDPATH**/ ?>