            ...
            <div class="form-group">
               <label >Leave Type <span class="required-icon"></span></label>
                <select class="form-control w-100 custom" name="leave_type" id="leave_type">
                  ...
                  <?php if($user->casual_leave>0): ?>
                  <option value="casual_leave" <?php if(old('leave_type') == 'casual_leave'): ?> selected <?php endif; ?>>Casual Leave</option>
                  <?php else: ?>
                  <option value="casual_leave" <?php if(old('leave_type') == 'casual_leave'): ?> selected <?php endif; ?> disabled>Casual Leave</option>
                  <?php endif; ?>
                  <option value="medical_leave" <?php if(old('leave_type') == 'medical_leave'): ?> selected <?php endif; ?>>Medical Leave</option>
                  <?php if(auth()->user()->gender=='M'): ?>
                  <option value="paternity_leave" <?php if(old('leave_type') == 'paternity_leave'): ?> selected <?php endif; ?>>Paternity Leave</option>
                  <?php elseif(auth()->user()->gender=='F'): ?>
                  <option value="maternity_leave" <?php if(old('leave_type') == 'maternity_leave'): ?> selected <?php endif; ?>>Maternity Leave</option>
                  <?php endif; ?>
                  <option value="bereavement_leave" <?php if(old('leave_type') == 'bereavement_leave'): ?> selected <?php endif; ?>>Bereavement Leave</option>
             ...
             <input type="hidden" id="cl" name="cl" value="<?php echo e($user->casual_leave); ?>">
             <input type="hidden" id="ml" name="ml" value="<?php echo e($user->medical_leave); ?>">
             <?php if($user->gender=='M'): ?>
              <input type="hidden" id="pl" name="pl" value="<?php echo e($user->paternity_leave); ?>">
             <?php elseif($user->gender=='F'): ?>
              <input type="hidden" id="mal" name="mal" value="<?php echo e($user->maternity_leave); ?>">
             <?php endif; ?>
