                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="side-bar d-lg-block d-none">
                                <ul>
                                    <li> <a href="<?php echo e(route('employee.group_members', $grp->id)); ?>"><i class="material-icons">people</i> Members</a> </li>
                                    <li> <a href="<?php echo e(route('employee.leave_requests', ['id' => $grp->id, 'eid' => $employee->id])); ?>" class="active"><i class="material-icons">people</i> Leave Requests</a> </li>
                                                            ...
                                                            <td>
                                                                <div class="dropdown dropleft">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                        <a class="dropdown-item" href="<?php echo e(route('employee.leave_accept', ['id'=>$leaves->id, 'gid'=>$grp->id])); ?>">Approve</a>
                                                                        <a class="dropdown-item" data-target=".bd-example-modal-smr-<?php echo e($leaves->id); ?>">Reject</a>
            ...
            <div class="modal fade bd-example-modal-smr-<?php echo e($leaves->id); ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    ...
                    <div class="modal-content p-4">
                        ...
                        <form method="POST" action="<?php echo e(route('employee.leave_reject', ['id'=>$leaves->id, 'gid'=>$grp->id])); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/employee/leave_request.blade.php ENDPATH**/ ?>