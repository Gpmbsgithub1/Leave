                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="side-bar d-lg-block d-none">
                                <ul>
                                    <li><a href="<?php echo e(route('hr.add_document')); ?>" class="active"><i class="material-icons">publish</i> Upload Document</a></li>
                                    <li><a href="<?php echo e(route('hr.documents')); ?>"><i class="material-icons">folder</i> Uploaded Documents</a></li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-xl-6">
                                        <div class="card mt-3 mb-3">
                                            ...
                                            <div class="form-wrap">
                                                <form method="POST" action="<?php echo e(route('hr.edit_document_store', $doc->id)); ?>" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                    <div class="form-group">
                                                        <label>Document Name <span class="required-icon"></span></label>
                                                        <input class="form-control" name="doc_name" id="doc_name" value="<?php echo e($doc->document_name); ?>">
                                                        <?php if($errors->has('doc_name')): ?>
                                                         <span class="invalid-feedback" role="alert">
                                                         <?php echo e($errors->first('doc_name')); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control w-100 custom" name="employee">
                                                          ...
                                                          <option value="<?php echo e($emps->id); ?>"><?php echo e($emps->name); ?></option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="4" name="description"><?php echo e($doc->description); ?></textarea>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="field" align="left">
                                                            <span>
                                                            <input type="file" id="files" name="files[]" value="<?php echo e($file->path); ?>" multiple accept="application/pdf"  />
                                                        </span>
                                                        </div>
                                                    ...
                                                    <div class="button-holder">
                                                        <a class="btn btn-default mt-4 filz mr-3"><span>Cancel</span></a>
...
</html><?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/edit_document.blade.php ENDPATH**/ ?>