  ...
  <tbody>
    <tr>
      <th scope="row">Casual Leaves</th>
        <td><?php echo e(@$user->casual_leave); ?></td>
     <td><?php echo e(@$user->casual_util); ?></td>
      <td><?php echo e(@$user->casual_rem); ?></td>
    </tr>
    <tr>
      <th scope="row">Medical Leaves</th>
        <td><?php echo e(@$user->medical_leave); ?></td>
     <td><?php echo e(@$user->medical_util); ?></td>
      <td><?php echo e(@$user->medical_rem); ?></td>
    </tr>
    <tr>
      <th scope="row">Bereavement Leaves</th>
        <td><?php echo e(@$user->bereavement_leave); ?></td>
     <td><?php echo e(@$user->bereavement_util); ?></td>
      <td><?php echo e(@$user->bereavement_rem); ?></td>
    </tr>
    <?php if($user->gender=='F'): ?>
    <tr>
      <th scope="row">Maternity Leaves</th>
       <td><?php echo e(@$user->maternity_leave); ?></td>
     <td><?php echo e(@$user->maternity_util); ?></td>
      <td><?php echo e(@$user->maternity_rem); ?></td>
    </tr>
    <?php endif; ?>
    ...
    <tr>
     ...
     <td><?php echo e(@$user->paternity_util); ?></td>
      <td><?php echo e(@$user->paternity_rem); ?></td>
    </tr>
    <?php endif; ?>
     <tr>
      <th scope="row">Loss of Pay</th>
     <td>0</td>
     <td><?php echo e(@$user->loss_of_pay); ?></td>
      <td>0</td>
    </tr>
      <tr>
      <th scope="row">Seniority Leaves</th>
     <td><?php echo e(@$user->seniority_leave); ?></td>
     <td><?php echo e(@$user->seniority_util); ?></td>
      <td><?php echo e(@$user->seniority_rem); ?></td>
    </tr>
  </tbody>
</table>
</div>
