...
<div class="main-wrap">
      ...
      <div class="col-lg-2">
        <div class="side-bar d-lg-block d-none">
          ...
          <li><a href="<?php echo e(route('hr.create_employee')); ?>"><i class="material-icons">add_circle</i> Create Employee</a></li>
             ...
             <li><a href="<?php echo e(route('hr.inactive_employees')); ?>" class="active"><i class="material-icons">person_off</i> Inactive Employees</a></li>
          </ul>
        </div>
      </div>
 ...
 <!-- item -->
  ...
  <label for="box-1"></label>
      ...
      <td><?php echo e($emps->joining_date); ?></td>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item" href="#" data-toggle="modal" data-target=".bd-example-modal-sm-<?php echo e($emps->id); ?>">Activate</a>
  </div>
</div></td>
    </tr>
  </tbody>
    ...
    <div class="modal-content p-4">
     ...
     <span class="content">Do you really want to activate?</span>
      <div class="button-holder">
             ...
             <a href="<?php echo e(route('hr.act_employee', $emps->id)); ?>" class="btn btn-default mt-4 filz "><span>Activate</span></a>
           </div>
    </div>
  </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/inactive_employee.blade.php ENDPATH**/ ?>