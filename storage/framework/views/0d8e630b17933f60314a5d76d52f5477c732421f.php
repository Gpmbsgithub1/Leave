...
<head>
    ...
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
     ...
     <link rel="stylesheet" href="<?php echo e(asset('content/css/jquery-ui.css')); ?>" type=" text/css">
     <style type="text/css">
       .user-name{
        color: white;
       }
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-xl-6">
            <div class="card mt-3 mb-3">
              ...
              <div class="form-wrap">
                <form method="POST" id="employee_form" action="<?php echo e(route('hr.create_employee_store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
             ...
             <div class="form-group">
               <label >Employee ID <span class="required-icon"></span></label>
                <input id="employee_id" type="text" class="form-control" name="employee_id" value="<?php echo e(++$eid); ?>">
             ...
             <div class="form-group">
               <label >Designation <span class="required-icon"></span></label>
                <input id="designation" type="text" class="form-control" name="designation" value="<?php echo e(old('designation')); ?>">
             ...
             <div class="form-group">
               <label >Employment Type <span class="required-icon"></span></label>
                <select class="form-control w-100 custom" name="employment_type">
                  ...
                  <option value="contract" <?php if(old('employment_type')=='contract'): ?> selected <?php endif; ?>>Contract</option>
                  <option value="permanent" <?php if(old('employment_type')=='permanent'): ?> selected <?php endif; ?>>Permanent</option>
                </select>
...
<div class="form-group row ">
                            ...
                            <div class="form-check form-check-inline" >
                                <input class="form-check-input" type="radio" name="gender" value="M" <?php if(old('gender')=='M'): ?> checked <?php endif; ?>>
                                <label class="form-check-label" for="male">Male</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="gender" value="F" <?php if(old('gender')=='F'): ?> checked <?php endif; ?>>
...
<!-- form-group end-->
             ...
             <div class="form-group">
               <label >Alternate Email <span class="required-icon"></span></label>
                <input id="alternate_email" type="email" class="form-control" name="alternate_email" value="<?php echo e(old('alternate_email')); ?>" >
             ...
             <div class="form-group">
               <label >Emergency Contact Number(Alternate Phone Number) <span class="required-icon"></span></label>
                <input id="alternate_phone" type="text" class="form-control" name="alternate_phone" value="<?php echo e(old('alternate_phone')); ?>" >
             ...
             <div class="form-group">
               <label >Address <span class="required-icon"></span></label>
                <textarea rows="4" id="address" type="text" class="form-control" name="address" ><?php echo e(old('address')); ?></textarea>
             ...
             <div class="form-group">
              ...
              <input class="date form-control" id='birthdatepicker' name="birth_day">
              <div><i style="float: right;margin-top: -30px;margin-right: 15px !important;" class="material-icons mr-2">calendar_today</i></div>
             ...
             <div class="form-group">
              ...
              <input class="date form-control" id='weddingdatepicker' name="wedding_day">
              <div><i style="float: right;margin-top: -30px;margin-right: 15px !important;" class="material-icons mr-2">calendar_today</i></div>
             ...
             <div class="form-group">
               <label >Bank Account Details <span class="required-icon"></span></label>
                <textarea rows="4" id="bank_account" type="text" class="form-control" name="bank_account" ><?php echo e(old('bank_account')); ?></textarea>
             ...
             <div class="form-group">
               <label>Total Salary <span class="required-icon"></span></label>
                <input id="base_salary" type="text" class="form-control" name="base_salary" value="0" readonly>
...
<?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/hr/create_employee.blade.php ENDPATH**/ ?>