        ...
        <div class="side-bar d-lg-block d-none">
          <ul>
            <li><a href="<?php echo e(route('employee.request_leave')); ?>"><i class="material-icons">add_circle</i> Request Leave</a></li>
             ...
             <li><a href="<?php echo e(route('employee.rejected_leaves')); ?>" class="active"><i class="material-icons">thumb_down</i> Rejected</a></li>
          </ul>
        </div>
      </div>
...
<?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/employee/reject_leave.blade.php ENDPATH**/ ?>