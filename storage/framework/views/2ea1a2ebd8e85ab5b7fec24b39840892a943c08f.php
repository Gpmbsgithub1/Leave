  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-7 gradient-bg d-none d-lg-block">
        ...
        <img width="550" class="img-fluid" src="<?php echo e(asset('content/img/signin.svg')); ?>" />
      </div>
      </div>
      <div class="col-lg-5">
          ...
          <form method="POST" action="<?php echo e(route('login')); ?>">
             ...
             <div class="form-group">
               <label >User Name <span class="required-icon"></span></label>
                <input id="employee_id" type="employee_id" class="form-control <?php $__errorArgs = ['employee_id'];
...
unset($__errorArgs, $__bag); ?>" name="employee_id" value="<?php echo e(old('employee_id')); ?>" required autocomplete="employee_id" maxlength="10" autofocus>
...
unset($__errorArgs, $__bag); ?>
          ...
          <span>
            ...
            <!-- <a href="<?php echo e(route('register')); ?>" class="link float-right">Register ?</a> -->
          </span>
        </div>
      </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\leave-tracker\resources\views/auth/login.blade.php ENDPATH**/ ?>