...
class MainController extends Controller
{
    ...
    public function create_company()
    {
        ...
        $user = User::where('_id', '=', $lv->user_id)->first();
        $d = $lv->dates;
        $start = explode(',', $d);
        ...
        // $cmp = Group::where('_id', '=', "6183d0ec7bbfb823e83ef092")->first();
        // $cmp = Group::where('_id', '=', "6183d18aa798ce07eb4b0512")->first();
        // $cmp = Group::where('_id', '=', "6183d232a00fe1144b34c5a3")->first();
        // $cmp = Group::where('_id', '=', "6183d2a5c086275314531412")->first();
        // $cmp = Group::where('_id', '=', "6183d2e67bbfb823e83ef095")->first();
        // $cmp = Group::where('_id', '=', "6183d33a2918243ebf0e66f2")->first();
        // $cmp = GroupMember::where('manager', '=', 1)->where('group_id', '=', "6183d3e457ffe64ef82d64d2")->first();
        // $cmp = Group::where('_id', '=', "6183d41c6b971c3c904e0c88")->first();
    ...
    public function leave_split()
    {
        ...
        $empl = User::where('_id', '=', $user[$k]->id)->first();
    ...
    public function pdf()
    {
        ...
        $user = User::where('employee_id', '=', 'SK0005')->first();
            ...
            $date = Carbon::now();
            $salary_month = $date->format('M Y');
        $empl = User::where('_id', '=', $user->id)->first();
        $month = Carbon::createFromFormat('F-d', "$current-1")->addMonth()->format('F');
        $mon = Carbon::createFromFormat('F-d', "$current-1")->addMonth()->format('M Y');
