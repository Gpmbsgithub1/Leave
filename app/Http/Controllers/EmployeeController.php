...
class EmployeeController extends Controller
{
    public function index()
    {
        ...
        $hr = User::where('_id', '=', $user->hr_id)->first();
    ...
    public function groups()
    {
        ...
        foreach ($group as $key => $groups) {
            $gp = Group::where('_id', '=', $groups->group_id)->first();
            $user = User::where('_id', '=', $groups->employee_id)->first();
    ...
    public function profile()
    {
        ...
        foreach ($member as $key => $members) {
            $grp = Group::where('_id', '=', $members->group_id)->first();
            $mem = GroupMember::where('group_id', '=', $members->group_id)->where('manager', '=', 1)->first();
            $man = User::where('_id', '=', $mem->employee_id)->first();
            $members->grp = $grp;
            $members->mem = $mem;
            $members->man = $man;
        }
        ...
        $hr = User::where('_id', '=', Auth::user()->hr_id)->first();
